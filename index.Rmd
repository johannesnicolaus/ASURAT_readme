...
By analyzing this matrix, users can cluster samples (or cells) to aid their
interpretation.
...
Description: In single-cell transcriptomics ASURAT assists users to cluster
    samples (or cells) in biologically explainable manners and find various
    types of biological terms specifically upregulated in each cluster.
