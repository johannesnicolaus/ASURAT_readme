# Appendix B: automatically tuning the ASURAT’s parameters
...
Below are the R scripts, which produces a series of images showing UMAPs of
the SSMs for DO.
...
`obj[["history"]]` for the fast computing.
```{r, eval = FALSE}
# ----------------------------------------
# Installation
# ----------------------------------------
