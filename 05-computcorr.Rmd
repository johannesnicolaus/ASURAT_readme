...
normalized read count matrices, which will be used later for creating signs.
...
(vector form is also accepted but not recommended due to the file size)
such as `pearson`, `spearman`, and `kendall`.
```{r, eval = FALSE}
